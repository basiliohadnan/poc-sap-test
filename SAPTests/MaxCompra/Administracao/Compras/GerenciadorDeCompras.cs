...
namespace SAPTests.MaxCompra.Administracao.Compras
{
    ...
    public class GerenciadorDeComprasTests : MaxCompraTests
    {
        ...
        public void CriarLoteLoja()
        {
            ...
            {
                string codFornecedor = Global.dataFetch.GetValue("CODFORNECEDOR", testName);
                string categoria = Global.dataFetch.GetValue("CATEGORIA", testName);
                string diasAbastecimento = Global.dataFetch.GetValue("DIASABASTECIMENTO", testName);
                int qtdLojas = int.Parse(Global.dataFetch.GetValue("QTDLOJAS", testName));
                int qtdProdutos = int.Parse(Global.dataFetch.GetValue("QTDPRODUTOS", testName));
                int qtdeCompra = int.Parse(Global.dataFetch.GetValue("QTDECOMPRA", testName));
                string tipoLote = Global.dataFetch.GetValue("TIPOLOTE", testName);
                string tipoPedido = Global.dataFetch.GetValue("TIPOPEDIDO", testName);
